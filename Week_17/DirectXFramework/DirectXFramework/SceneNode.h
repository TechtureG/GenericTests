...
public:
	...
	virtual void Update(const Matrix& worldTransformation) { _worldTransformation = _localTransformation * worldTransformation; }	
	virtual void Render() = 0;
	virtual void Shutdown() {}

	void SetWorldTransform(const Matrix& worldTransformation) { _localTransformation = worldTransformation; }
